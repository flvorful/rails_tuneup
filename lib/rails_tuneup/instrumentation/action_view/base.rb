        ...
        module Base
          ...
          module InstanceMethods
            def render_file_with_fiveruns_tuneup(path, *args, &block)
              name = RailsTuneup::Instrumentation::ActionView::Base.normalize_path(path)
              RailsTuneup.step "Render file #{name}", :view do
            ...
            def update_page_with_fiveruns_tuneup(*args, &block)
              ...
              name = RailsTuneup::Instrumentation::ActionView::Base.normalize_path(path)
              RailsTuneup.step "Render page update #{name}", :view do
            ...
            def render_with_fiveruns_tuneup(*args, &block)
              ...
              when String
                ...
                if RailsTuneup::Version.rails < RailsTuneup::Version.new(2,1,0)
                  record = false
                else
                  "Render #{options}"                  
                end
